 ...
 * 
 * $ npx keycloakify own --path "login/components/Template/theme/Themes.ts" --revert
 */
...
export const basePalettes: Record<BasePalette, ModeTokens<BaseSurfaceTokens>> = {
    // Velobits brand surfaces: near-black with a subtle olive-green tint
    // (hue ~122), matching the product's dark-first design reference.
    velobits: {
        light: {
            background: "oklch(0.985 0.005 120)",
            foreground: "oklch(0.17 0.015 122)",
            card: "oklch(1 0 0)",
            cardForeground: "oklch(0.17 0.015 122)",
            popover: "oklch(1 0 0)",
            popoverForeground: "oklch(0.17 0.015 122)",
            secondary: "oklch(0.95 0.012 120)",
            secondaryForeground: "oklch(0.24 0.02 122)",
            muted: "oklch(0.95 0.012 120)",
            mutedForeground: "oklch(0.5 0.02 120)",
            accent: "oklch(0.93 0.03 122)",
            accentForeground: "oklch(0.24 0.02 122)",
            border: "oklch(0.9 0.012 120)",
            input: "oklch(0.9 0.012 120)",
            ring: "oklch(0.72 0.14 122)"
        },
        dark: {
            background: "oklch(0.16 0.015 122)",
            foreground: "oklch(0.97 0.01 120)",
            card: "oklch(0.19 0.018 122)",
            cardForeground: "oklch(0.97 0.01 120)",
            popover: "oklch(0.21 0.02 122)",
            popoverForeground: "oklch(0.97 0.01 120)",
            secondary: "oklch(0.26 0.022 122)",
            secondaryForeground: "oklch(0.97 0.01 120)",
            muted: "oklch(0.26 0.022 122)",
            mutedForeground: "oklch(0.71 0.02 120)",
            accent: "oklch(0.26 0.022 122)",
            accentForeground: "oklch(0.97 0.01 120)",
            border: "oklch(1 0 0 / 12%)",
            input: "oklch(1 0 0 / 15%)",
            ring: "oklch(0.83 0.16 122)"
        }
    },
    neutral: {
        light: {
...
export const themePresets: Record<ThemePreset, ModeTokens<AccentTokens>> = {
    // Velobits neon-lime accent with dark olive text on the filled button,
    // per the brand design reference. Slightly deeper in light mode so the
    // button keeps contrast against white surfaces.
    velobits: {
        light: {
            primary: "oklch(0.87 0.2 122)",
            primaryForeground: "oklch(0.2 0.04 122)"
        },
        dark: {
            primary: "oklch(0.93 0.21 122)",
            primaryForeground: "oklch(0.2 0.04 122)"
        }
    },
    neutral: {
